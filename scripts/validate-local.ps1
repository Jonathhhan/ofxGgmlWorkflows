...
Assert-Path (Join-Path $repoRoot "docs\future-ecosystem-roadmap.md") "future ecosystem roadmap"
...
Assert-Path (Join-Path $repoRoot "scripts\test-evidence-validator.ps1") "evidence validator tests"
Assert-Path (Join-Path $repoRoot "scripts\workflow-metadata-extractor.ps1") "workflow metadata extractor"
Assert-Path (Join-Path $repoRoot "tests\evidence\full-quality.json") "full-quality evidence fixture"
Assert-Path (Join-Path $repoRoot "tests\evidence\invalid-optional-fields.json") "invalid optional fields evidence fixture"
...
Assert-NoBom (Join-Path $repoRoot "docs\future-ecosystem-roadmap.md") "future ecosystem roadmap"
...
Assert-NoBom (Join-Path $repoRoot "scripts\test-evidence-validator.ps1") "evidence validator tests"
...
Assert-FileContains (Join-Path $repoRoot "README.md") "future-ecosystem-roadmap.md" "README"
...
Assert-FileContains (Join-Path $repoRoot "docs\evidence-schema-v1.md") "workflow_run_id" "evidence schema docs"
Assert-FileContains (Join-Path $repoRoot "docs\evidence-schema-v1.md") "artifact_sha256" "evidence schema docs"
Assert-FileContains (Join-Path $repoRoot "docs\future-ecosystem-roadmap.md") "ofxGgmlSam" "future ecosystem roadmap"
Assert-FileContains (Join-Path $repoRoot "docs\future-ecosystem-roadmap.md") "adoption matrix" "future ecosystem roadmap"
...
Assert-FileContains (Join-Path $workflowRoot "release-gate.yml") "release_readiness_score_path" "release-gate.yml"
Assert-FileContains (Join-Path $workflowRoot "release-gate.yml") "require_metadata_reconciliation_report" "release-gate.yml"
Assert-FileContains (Join-Path $workflowRoot "release-gate.yml") "metadata_reconciliation_report_path" "release-gate.yml"
Assert-FileContains (Join-Path $workflowRoot "release-gate.yml") "require_cross_repo_capability_map" "release-gate.yml"
Assert-FileContains (Join-Path $workflowRoot "release-gate.yml") "cross_repo_capability_map_path" "release-gate.yml"
Assert-FileContains (Join-Path $workflowRoot "release-gate.yml") "validate_report_path" "release-gate.yml"
Assert-FileContains (Join-Path $workflowRoot "release-gate.yml") "RELEASE_READINESS_SCORE_PATH" "release-gate.yml"
...
Assert-FileContains (Join-Path $repoRoot "scripts\validate-evidence.py") "VALID_TREE_STATES" "evidence validator"
Assert-FileContains (Join-Path $repoRoot "scripts\validate-evidence.py") "artifact_integrity" "evidence validator"
