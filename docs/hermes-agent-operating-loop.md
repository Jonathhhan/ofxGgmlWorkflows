...
| Multi-agent improvement | `ofxGgmlWorkflows\docs\hermes-multi-agent-improvement.md`, `scripts\plan-hermes-agent-improvement.ps1 -Json`, specialized role profiles, addon lane briefs, agent baseline, handoff contract, eval catalog |
