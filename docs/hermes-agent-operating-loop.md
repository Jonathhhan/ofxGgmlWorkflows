...
| Multi-agent improvement | `ofxGgmlWorkflows\docs\hermes-multi-agent-improvement.md`, `scripts\plan-hermes-agent-improvement.ps1 -Json`, `scripts\plan-hermes-agent-improvement.ps1 -PromptQueue -Json`, specialized role profiles, addon lane briefs, `prompt_packet` launch prompts, `prompt_launch_queue`, agent baseline, handoff contract, eval catalog |
